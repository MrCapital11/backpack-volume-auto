...
DELAY_BETWEEN_TRADE = (5, 40)  # Execute delay between every trade (Buy -> Delay -> Sell -> Buy -> Delay ...)
DELAY_BETWEEN_DEAL = (20, 100)  # Execute delay between full trade (Buy -> Sell -> Delay -> Buy -> Sell -> Delay ...)
...
ALLOWED_ASSETS = ["SOL_USDC", "WEN_USDC"]
